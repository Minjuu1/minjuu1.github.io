...
Politicians can create policies by observing various problem situations or create and present policies based on their own values. In this process, VOTY, a rule-based chatbot, plays a role in providing step-by-step scaffolding for more effective training.
