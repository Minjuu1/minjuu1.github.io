...
## Prototype
**Demo Video**
[![Video Label](http://img.youtube.com/vi/n_b35oDLMt0/0.jpg)](https://youtu.be/n_b35oDLMt0)
...
### Limitations
- Timing was prior to LLM development, so constraints in implementing features were not addressed.
...
- Redefined social skills
> the ability to understand and empathize with the feelings of others and to communicate based on those feelings.

- Selected and organized learning contents by referencing existing social skills training materials and papers

- Designed the overall structure of the game

### Develop

- Scaffolding for incorrect quiz answers

- Voice chat with randomized matching

- Pop-up checklist for transferring learning
